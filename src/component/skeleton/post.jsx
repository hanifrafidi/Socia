...
export default function post() {
  return (
    <Box sx={{ px: {xs: 2, md: 5}, pt: {xs: 2, md: 5}, pb: 4, backgroundColor: '#fff', borderRadius: 1.5 }}>
        <Skeleton animation="wave" variant='rectangular' width='100%' sx={{ height: { xs: '30vh', md :'65vh', xl :'50vh'} }} ></Skeleton>
